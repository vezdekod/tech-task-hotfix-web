  ...
  return (
    <div className="Place Place_order">
      ...
      <div className="Place__order-body">
        <h3 className="Place__order-number-header">Номер вашего заказа</h3>
        <main className="Place__order-number">7</main>
        <p className="Place__order-number-header">Заказ будет готов через</p>
        <h3 className="Place__order-time">~ 15 минут</h3>
      </div>
